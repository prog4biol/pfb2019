...
# Python 08, problem 8
# ====================
# Finally determine which subset of codons produced the longest
# peptide for each sequence record. Print this to a fourth file
# in FASTA format (Python_08.orf-longest.nt).
