...
# Create one file for which you print the six reading frames
# (Python_08.codons-6frames.nt) and one file for which you
# print the translation of the six reading frames
