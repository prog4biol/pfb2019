...
Sofia Robb     
   ...
   * [Python Lectures](#python-lectures)
      * [Python 1](#python-1)
         * [Python Overview](#python-overview)
         * [Running Python](#running-python)
            * [Interactive Interpreter](#interactive-interpreter)
            * [Python Scripts are Text Files](#python-scripts-are-text-files)
      ...
      * [Python 3](#python-3)
         ...
         * [Strings](#strings)
            ...
            * [print() and Common Errors](#print-and-common-errors)
            ...
            * [Replace one string with another](#replace-one-string-with-another)
            * [Extracting a Substring, or Slicing](#extracting-a-substring-or-slicing)
            * [Reverse a string or a list](#reverse-a-string-or-a-list)
      ...
      * [Python 8](#python-8)
         * [Data Structures](#data-structures)
            ...
            * [Building Complex Datastructures](#building-complex-datastructures)
   ...
   * [Python 9](#python-9)
         ...
         * [Modules](#modules)
            ...
            * [subprocess](#subprocess)
               ...
               * [Redirect stdout to a file inside python subprocess](#redirect-stdout-to-a-file-inside-python-subprocess)
            * [sys](#sys)
            * [re](#re)
   ...
   * [Python 10](#python-10)
         * [Classes](#classes)
      * [Python 10](#python-10-1)
         * [Classes](#classes-1)
            * [You have been using classes to create objects](#you-have-been-using-classes-to-create-objects)
            * [attributes and methods](#attributes-and-methods)
            * [Creating a Class](#creating-a-class)
            * [Retrieving attribute values](#retrieving-attribute-values)
            * [Using class methods](#using-class-methods)
            * [Getting data into a new instance of our class](#getting-data-into-a-new-instance-of-our-class)
               * [<strong><strong>init</strong></strong>](#init)
